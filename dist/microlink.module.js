...
var u = function (u) {
  ...
  return function (e, t) {
    ...
    value: function value() {
      ...
      return u ? /*#__PURE__*/createElement(c, a, n) : null;
    }
  }]) && n(f.prototype, p), a;
}();
...
var Clamp = function Clamp(_ref) {
  var children = _ref.children,
      ...
      lines = _ref.lines;
  return isNil(children) ? null : /*#__PURE__*/React.createElement(u, {
    className: className,
    lines: lines,
    text: children,
    is: "p"
...
var StyledClamp = styled(Clamp)(_templateObject$1(), function (_ref2) {
  var useNanoClamp = _ref2.useNanoClamp;
  return !useNanoClamp && css(_templateObject2$1());
});
...
var mobileDescriptionStyle = css(_templateObject$2(), media.mobile(_templateObject2$2()));
var Content = styled('div').attrs({
  className: classNames.content
})(_templateObject3(), function (_ref) {
  var cardSize = _ref.cardSize;
  return css(_templateObject4(), !isLarge(cardSize) ? 1 : '0 0 125px', !isSmall(cardSize) ? 'space-around' : 'space-between', !isSmall(cardSize) ? 'column' : 'row', !isSmall(cardSize) ? 'stretch' : 'center');
});
var Header = styled('header').attrs({
  className: classNames.title
})(_templateObject5(), function (_ref2) {
  var cardSize = _ref2.cardSize;
  return css(_templateObject6(), !isSmall(cardSize) ? 1.2 : 0.8, !isSmall(cardSize) ? '16px' : '15px', isSmall(cardSize) && css(_templateObject7()));
});
...
var emptyStateImagePulse = keyframes(_templateObject2$3());
...
var loadingOverlay = css(_templateObject2$4(), transition.medium('opacity', 'visibility'), function (_ref) {
  var isLoading = _ref.isLoading;
  return css(_templateObject3$2(), isLoading ? 1 : 0, isLoading ? 'visible' : 'hidden');
});
...
var mediaSizeStyles = {
  small: css(_templateObject$5()),
  normal: css(_templateObject2$5(), media.mobile(_templateObject3$3())),
  large: css(_templateObject4$2())
};
var StyledWrap = styled('div')(_templateObject5$1(), function (_ref) {
  var cardSize = _ref.cardSize;
...
var ImageWrap = styled(Wrap).attrs({
...
var MediaEmpty = styled(ImageComponent)(_templateObject$7(), emptyStateImageAnimation);
var HeaderEmpty = styled('span')(_templateObject2$6(), function (_ref) {
  var cardSize = _ref.cardSize;
...
var DescriptionEmpty = styled('span')(_templateObject3$4(), emptyStateAnimation);
var FooterEmpty = styled('span')(_templateObject4$3(), emptyStateAnimation, function (_ref4) {
  var cardSize = _ref4.cardSize;
  return !isLarge(cardSize) && "\n    height: 10px;\n  ";
});

var _ref5 = /*#__PURE__*/React.createElement(FooterEmpty, null);
...
var MediaButton = styled('div')(_templateObject$8(), transition.short('transform'));
...
var BottomControls = styled('div')(_templateObject$9(), function (_ref3) {
  var cardSize = _ref3.cardSize;
  return isLarge(cardSize) ? 18 : 14;
}, transition.medium('opacity'));
var VolumeIcon = styled('svg')(_templateObject2$7());
...
var PlaybackIcon = styled('svg')(_templateObject$a());
var PlaybackButtonWrap = styled(MediaButton).attrs({
  ...
  var cardSize = _ref3.cardSize;
  return css(_templateObject3$6(), iconSizes[cardSize], iconSizes[cardSize], isLarge(cardSize) ? 0 : '8px', !isLarge(cardSize) && !isSmall(cardSize) && media.mobile(_templateObject4$5(), iconSizes.small, iconSizes.small));
});
...
var Scrubber = styled('div').attrs(function (_ref) {
  ...
  return css(_templateObject2$9(), scrubberSize, scrubberSize);
});
...
var OuterWrap = styled('div').attrs(function () {
  return {
...
var BarsWrap = styled('div').attrs(function (_ref) {
  ...
  var activeHeight = getProgressBarActiveHeight(cardSize);
  return css(_templateObject3$7(), height, OuterWrap, activeHeight);
});
var ProgressLine = styled('div')(_templateObject4$6());
...
var ProgressBar = function ProgressBar(_ref6) {
  ...
  return /*#__PURE__*/React.createElement(OuterWrap, _extends({
    cardSize: size,
    ref: wrapRef
...
var SeekIcon = styled('svg')(_templateObject$e(), function (_ref5) {
  var cardSize = _ref5.cardSize;
...
var SeekButtonWrap = styled(MediaButton)(_templateObject3$8(), function (_ref8) {
  var cardSize = _ref8.cardSize;
...
var rotate = keyframes(_templateObject$f());
var dash = keyframes(_templateObject2$c());
var Wrap$1 = styled(MediaButton).attrs(function (_ref) {
  var isVisible = _ref.isVisible;
  return {
    style: {
      opacity: isVisible ? 1 : 0,
  ...
  return css(_templateObject3$9(), size, offset, offset, transition.medium('opacity', 'visibility'));
});
var Svg = styled('svg')(_templateObject4$7(), rotate);
var Circle = styled('circle')(_templateObject5$4(), dash);

var _ref4$1 = /*#__PURE__*/React.createElement(Svg, {
  viewBox: "0 0 50 50"
...
var Spinner = function Spinner(_ref3) {
  var size = _ref3.size,
      isVisible = _ref3.isVisible;
  return /*#__PURE__*/React.createElement(Wrap$1, {
    cardSize: size,
...
var R_ARROW_KEY = 39;
var M_KEY = 77;
var OuterWrap$1 = styled('div').attrs({
  ...
  return css(_templateObject2$d(), classNames.main, !isDragging ? bg : dragBg, classNames.main, !hasInteracted || isPaused ? 1 : 0, isPaused && "background: ".concat(bg));
});
var InnerWrap = styled('div')(_templateObject3$a());
var ControlsTop = styled('div')(_templateObject4$8(), function (_ref2) {
  var isVisible = _ref2.isVisible;
  return !isVisible && css(_templateObject5$5(), classNames.mediaControls, classNames.progressTime, transition.medium('opacity', 'visibility'));
});
...
var Controls = function Controls(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(MediaComponent, _extends({}, mediaProps, mediaEvents, {
    ...
    loop: loop,
    muted: muted
  })), controls && /*#__PURE__*/React.createElement(OuterWrap$1, _extends({}, outerWrapTitle, {
    tabIndex: 0,
...
var VideoDOM = styled('video')(_templateObject$h());
...
var contrastStyle = function contrastStyle(_ref) {
  var backgroundColor = _ref.backgroundColor,
      color = _ref.color;
  return css(_templateObject$i(), backgroundColor, color, color);
};

var largeStyle = css(_templateObject2$e(), HEIGHT$1, media.mobile(_templateObject3$b(), HEIGHT$1));
var hoverStyle = css(_templateObject4$9());

var rtlStyle = function rtlStyle(_ref2) {
  var cardSize = _ref2.cardSize;
  return css(_templateObject5$6(), isLarge(cardSize) ? 'column-reverse' : 'row-reverse');
};
...
var _ref2$3 = /*#__PURE__*/React.createElement(CardEmptyState, null);

var _ref3 = /*#__PURE__*/React.createElement(CardMedia, null);

var _ref4$2 = /*#__PURE__*/React.createElement(CardContent, null);
...
var Card = function Card(props) {
  ...
  return /*#__PURE__*/React.createElement(CardWrap, _extends({
    ...
    isLoading: isLoading,
    ref: cardRef
  }, restProps), isLoading ? _ref2$3 : /*#__PURE__*/React.createElement(React.Fragment, null, _ref3, _ref4$2));
};
